<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransactionList.ascx.cs" Inherits="RockWeb.Plugins.com_centralaz.Finance.TransactionList" %>
                ...
                <div class="panel-body">
                    ...
                    <div class="grid grid-panel">
                        <Rock:GridFilter ID="gfTransactions" runat="server">
                            ...
                            <Rock:CampusPicker ID="campCampusPerson" runat="server" Label="Campus (of Person)" />
