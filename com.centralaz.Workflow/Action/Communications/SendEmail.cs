...
namespace com.centralaz.Workflow.Action.Communications
{
    /// <summary>
    /// Sends email
    /// </summary>
    [ActionCategory( "com_centralaz: Communications" )]
    ...
    [Obsolete("This is a temporary action to work around issue #2904 which is scheduled to be fixed in v7.4")]
    ...
    public class SendEmail : ActionComponent
    {
        ...
        private void Send( string recipients, string fromEmail, string fromName, string subject, string body, Dictionary<string, object> mergeFields, RockContext rockContext, bool createCommunicationRecord, BinaryFile[] attachments )
        {
            ...
            emailMessage.EnabledLavaCommands = GlobalAttributesCache.Read().GetValue( "DefaultEnabledLavaCommands" );
